...
export const meta = {
  author: 'Kyle Wu',
  date: '2023-04-09',
  title: 'Personal Website: My journey with frontend development',
  description:
    'When you’re building a personal website, you need to make an impression. I wanted people to visit my website once and then immediately become invested in my journey.',
}
...
To make this possible, I needed my website to be seamless and attractive by remain genuine. And so I began to explore TailwindCSS.
